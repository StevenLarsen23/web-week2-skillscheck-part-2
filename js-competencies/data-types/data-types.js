...
let myArray = [1, 'two', {three: 3}, new Array(4, 5)]
...
let nananan = (param) => isNaN(param / 2) ? "FLYING NOCTURNAL MAMMAL MAN!" : param / 2
...
let arrayChecker = (param) => Array.isArray(param) ? true : false
